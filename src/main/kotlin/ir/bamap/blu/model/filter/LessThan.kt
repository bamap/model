...
open class LessThan(propertyName: String = "", literal: Any = 0) : ComparativeOperatorFilter(propertyName, literal) {

    override fun toString(): String = "\"$propertyName\" < ${FilterUtil.getValueSqlClause(literal)}"

    override fun clone(literal: Any, propertyName: String): LessThan = LessThan(propertyName, literal)
